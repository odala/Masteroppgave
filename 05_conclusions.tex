...
The as-received substrate C was surprisingly full of particles \todo{density instead}. While the as-received (111)B-oriented substrate A from the same vendor had no particles on the surface, the (211)-oriented substrate C was full of particles \todo{density instead}. Are all the particles due to the fact that the (211)-oriented surface is not atomically flat, but consists of (111)-oriented steps? \todo{Flere resuktater.} Results on substrate C were the same as Benson, but their etch semms better than ours. We must try their etch procedure and see if that improves the surface.
