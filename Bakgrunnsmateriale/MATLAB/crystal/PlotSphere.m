function handles = PlotSphere(x,y,z,r,varargin)
%BUBBLEPLOT3  A simple 3D-bubbleplot.
%     PlotSphere() is a three-dimensional bubbleplot.
%   
%     PlotSphere(x,y,z,r), where x, y, z and r are four vectors of the 
...
% 
%     PlotSphere(x,y,z,r,c), where c is a rgb-triplet array (in [0,1])
%     with numel(x) rows, plots bubbles with colours specified by c.
% 
%     PlotSphere(x,y,z,r,c,Alpha), where Alpha is a scalar with value from 
%     0.0 to 1.0, plots bubbles with FaceAlpha Alpha.
% 
%     PlotSphere(x,y,z,r,c,Alpha,n,m), where m and n are scalar values that
...
%     
%     PlotSphere(x,y,z,r,c,Alpha,n,m,'PropertyName',PropertyValue,...)
%     Any property-value pair setting valid for a SURFACE object can be
%     passed as optional parameters.
%   
%     PlotSphere returns a column vector of handles to surface objects.
%
...
% Author: Oda Lauten
% Email: odalauten@gmail.com
% Created: 21-Feb-2017 15:14:21
xargs={};
