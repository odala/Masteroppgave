...
A film of \ac{mct} was grown on substrate B by \ac{lpe}. Nomarski optical microscopy images revealed that the surface of the \ac{mct} film had wavy structures with a large number of circular features, as seen in Fig.~\ref{fig:subBc_om}. The same two kinds of circular features were observed on this \ac{mct} film as the one grown on substrate A: large circular defects with diameter of \SIrange{38}{70}{\micro\metre} and donut-shaped defects with diameter of \SIrange{8}{16}{\micro\metre}.
