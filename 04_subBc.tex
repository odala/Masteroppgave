...
\begin{figure}[htbp]
    ...
    \caption[Nomarski phase contrast microscopy images of \ac{mct} film grown by \ac{lpe} on substrate B.]{Nomarski phase contrast microscopy images of \ac{mct} film grown by \ac{lpe} on (111)B-oriented substrate B: \subref{fig:subBc_om_centre} Centre; and \subref{fig:subBc_om_edge} upper right corner.}
    \label{fig:subBc_om}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \mySubfigure{0.60175438596\linewidth}{LPE453_ftir_spectra.png}[fig:subB2c_ftir_spectra]
    \hfill
    \mySubfigure{0.37824561403\linewidth}{LPE453_ftir_transmission_at_k500cm-1.png}[fig:subB2c_ftir_map_500cm-1]
