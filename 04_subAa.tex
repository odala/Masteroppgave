...
Almost all the spectra from substrate A had a value of $T_{5000}$ between \SI{63}{\percent} and \SI{67}{\percent}, $T_{1000}$ between \SI{62}{\percent} and \SI{64}{\percent}, and $T_{1000}/T_{5000}$ approaches one from below. According to \citet{yujie2004infrared}, the \ac{czt} substrates with these characteristics were free of precipitates, had low free carrier concentration, and had resistivity that exceeded \SI{e6}{\ohm\centi\metre}.%\todo{Why?}
%%========================================
