...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption[\Ac{ftir} measurements of the as-received substrate A.]{\Acf{ftir} measurements recorded from a $11\times11$ grid on the as-received (111)B-oriented substrate A: \subref{fig:subAa_ftir_spectra} Transmission spectra; \subref{fig:subAa_ftir_map_500cm-1} transmission map at wavenumber $k=\SI{500}{\centi\metre^{-1}}$.}
\end{figure}
