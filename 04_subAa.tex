...
\begin{figure}[htbp]
    \centering
    \mySubfigure[Corner.]{0.48\textwidth}{LM_DF_BZ1503ID71A_M005_corner_with_skraa.jpg}[fig:LM_DF_BZ1503ID71A_M005_corner_with_skraa]
    %\quad
    \mySubfigure[Edge.]{0.48\textwidth}{LM_DF_BZ1503ID71A_M005_edge.jpg}[fig:LM_DF_BZ1503ID71A_M005_edge]
    \par\bigskip
    \mySubfigure[Centre.]{\linewidth}{LM_DF_BZ1503ID71A_M005_centre.jpg}[fig:LM_DF_BZ1503ID71A_M005_centre]
...
\begin{table}[htbp]
    ...
    \hline
        ...
        \textbf{$X$} (\SI{}{\milli\metre}) &  \textbf{$Y$} (\SI{}{\milli\metre}) & \textbf{\ce{Cd}}\newline(at.\%) & \textbf{\ce{Te}}\newline(at.\%) & \textbf{\ce{O} }\newline(at.\%) & \textbf{\ce{C}}\newline(at.\%) & \textbf{\ce{Te} oxide thickness (\SI{}{\nano\metre})}\\
        \hline
         0 & 0 & \SI{18.8}{} & \SI{25.1}{} & \SI{32.6}{} & \SI{23.5}{} & \SI{0.96}{} \\
         \hline
    \end{tabu}
\end{table}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\linewidth]{subAa_ftir_spectrum.png}
