...
\begin{figure}[htbp]
    ...
    \caption{}\label{fig:subBa_microvoids}
          ...
          \end{minipage}
    \end{subfigure}%
    \caption[\Ac{sem} images of voids on substrate B.]{\Ac{sem} images of \subref{fig:subBa_high-temperature-voids} high temperature voids and \subref{fig:subBa_microvoids} microvoids on the as-received substrate B.}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.49\linewidth}
        ...
        \includegraphics[width=\linewidth]{unknown.png}
    \end{subfigure}%
    \caption[\Ac{afm} measurements of void and microvoid on as-received substrate B.]{\Ac{afm} measurements of \subref{fig:subBa_afm_void} a high temperature void and \subref{fig:subBa_afm_microvoid} a microvoid on the as-received substrate B.}
