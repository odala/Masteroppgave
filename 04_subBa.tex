...
\begin{figure}[htbp]
    ...
    \end{subfigure}%
    \caption[\Ac{sem} images, \ac{eds} spectra, and \ac{eds} atomic compositions of one void and six different types of particles found on as-received substrate B.]{High resolution \acf{sem} images of one void and six different types of particles found on the as-received substrate B and the corresponding \acf{eds} spectra and atomic compositions: \subref{fig:SEM_C389523_void_eds} void; \subref{fig:SEM_B_particulates_eds} \ac{czt} paticle; \subref{fig:subBa_polishing-grit_alumina} alumina (\ce{Al2O3}) and silica (\ce{SiO2}) polishing grit; \subref{fig:subBa_polishing-grit_silica} silica (\ce{SiO2}); \subref{fig:subBa_particle_carbon} carbon-based particle; \subref{fig:EDS_NaClO} \ce{NaClO}; and \subref{fig:subBa_partice_Fe} iron (\ce{Fe}).}\label{fig:subBa_sem_w_eds}
\end{figure}
%
\begin{figure}[htbp]
\ContinuedFloat
...
Irregular shaped pits were observed all over the surface of substrate B, see Fig.~\ref{fig:SEM_C389523_voids}. The size of the pits tends to be between \SI{5}{} and \SI{100}{\micro\metre}. \Ac{afm} gives that the pits are between \todo{\SI{}{\nano\metre} and \SI{}{\nano\metre}} deep, see Fig.~\ref{subBa_afm_voids}. The larger ones tend to have more angular shapes than the smaller ones. The \ac{eds} spectrum in Fig.~\ref{fig:SEM_C389523_void_eds} reveals that the pit has the same composition as the substrate surface.
...
\begin{figure}[htbp]
    ...
    \caption[\Ac{sem} images of an accumulaton of polishing grit on substrate B.]{\Acf{sem} images of an accumulation of polishing grit on the as-received substrate B at a magnification of \subref{fig:subBa_polishing-grit_area1} $200\times$ and \subref{fig:subBa_polishing-grit_area2} $15000\times$.}\label{fig:subBa_polishing-grit_area}
\end{figure}
...
\begin{figure}
    ...
    \caption[\Acf{sem} image of \ce{NaClO} particles on substrate B.]{\Acf{sem} image of \ce{NaClO} particles on substrate B.}
...
\begin{figure}[htbp]
    \centering
    \mySubfigure{0.48\linewidth}{C-3895-23A_edx1_m001.jpg}[fig:EDX_C-3895-23Ad_m001]
    \mySubfigure{0.48\linewidth}{C-3895-23A_edx1_m005.jpg}[fig:EDX_C-3895-23A_edx1_m005]
    \par\bigskip
    \mySubfigure{0.48\linewidth}{C-3895-23A_edx1_m003.jpg}[fig:EDX_C-3895-23A_edx1_m003]
    \mySubfigure{0.48\linewidth}{C-3895-23A_edx1_m016.jpg}[fig:EDX_C-3895-23A_edx1_m016]
    \caption[\Ac{sem} images of stains on substrate B.]{\Acf{sem} images of \subref{fig:EDX_C-3895-23Ad_m001}--\subref{fig:EDX_C-3895-23A_edx1_m005} bright and \subref{fig:EDX_C-3895-23A_edx1_m003}--\subref{fig:EDX_C-3895-23A_edx1_m016} dark stains on substrate B.}
...
\begin{figure}[htbp]
    \centering
    \mySubfigure{0.48\linewidth}{C-3895-23Ad_m002.jpg}[fig:C-3895-23Ad_m002]
    \mySubfigure{0.48\linewidth}{C-3895-23A_J08_detail.jpg}[fig:C-3895-23A_J08_detail]
    \caption[\Ac{sem} images of scratches on substrate B.]{\Acf{sem} images of \subref{fig:C-3895-23Ad_m002} polishing scratches and \subref{fig:C-3895-23A_J08_detail} deep scratches on substrate B.}
...
\todo{Beskriv} Fig.~\ref{fig:subB2a_ftir_spectra} \todo{Free carrier absorption. The spikes near $k=\SI{4500}{\centi\metre^{-1}}$ and $k=\SI{5000}{\centi\metre^{-1}}$ are an artefact of the \ac{ftir} instrument and should not be considered.} 
...
\citet{sealy2000mechanism} showed that p-type semiconductors in general appear brighter and that n-type in general appear darker than undoped material in \ac{sem}. \todo{fit with the skrå spektra. Free carrier absorption. Er det n eller p? Kan ses fra kontrast iflg. enkelte artikler. Work function?}
