...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption[\Ac{ftir} measurements of the as-received substrate B2.]{\Acf{ftir} measurements recorded from a $11\times11$ grid on the as-received (111)B-oriented substrate B2: \subref{fig:subB2a_ftir_spectra} Transmission spectra; \subref{fig:subB2a_ftir_map_500cm-1} transmission map at wavenumber $k=\SI{500}{\centi\metre^{-1}}$.}
\end{figure}
