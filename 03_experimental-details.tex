...
\begin{figure}[htbp]
    ...
    \quad
    \mySubfigure[A and B face of the zincblende structure cut along the (111) plane.\todo{edit figure: direction should be in brackets [111]}]{0.623076923\linewidth}{zinc-blende_faces.png}[fig:zincblende-face]
...
Substrate B was unfortunately shattered during preparation for \ac{ftir} even though the preparation procedure was followed as normal, see Fig.~\ref{fig:subB_om_6x_pieces}. It could be the additional handling that caused it to be more fragile, i.e. transfer between the different equipment used in the characterisation. Substrate B was already studied as-received and with surface pre-growth preparation (except for \ac{ftir}). The next step was to grow \iac{mct} film on it.  To be able to fulfil the process, an additional substrate from vendor B was studied (substrate B2). Due to lack of time substrate B was only studied after surface pre-growth preparation, not as-received, before \iac{mct} film was grown on it.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.48\linewidth]{subBb_om_pieces.JPG}
    \caption[Optical microscopy image of substrate B after it broke into smaller pieces.]{Optical microscopy image of substrate B after it broke into smaller pieces during preparation for \ac{ftir}.\todo{Putt på målestav og beskjær.}}
...
Transmission \ac{ir} microscopy was performed using the Leica DM RXA2 optical microscope with transmitted illumination from a halogen light lamp at \SI{3450}{\kelvin} under the stage and a \todo{name of IR camera} for image recording, which can detect photons with wavelengths between \todo{\SI{200}{\nano\metre} and \SI{1100}{\nano\metre}}. The band gap in \ac{czt} is \SI{1.6}{\electronvolt}. Hence, photons with energy greater than the band gap, i.e. wavelengths smaller than \SI{775}{\nano\metre}, are not transmitted through the substrate. This results in the detection of photons with wavelengths between \SI{770}{\nano\metre} and \SI{1120}{\nano\metre}, see Fig.~\ref{fig:ir-range}. \todo{Images were processed using ...} \todo{The \ac{ir} transmisson images were used to ...} %\todo{Hvorfor har Espen skrevet 900? Se Matlab-fil.}
