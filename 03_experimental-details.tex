...
\begin{figure}[htbp]
    ...
    \caption[Optical microscopy images of the substrates.]{Optical microscopy images of the substrates: \subref{fig:subAa_photo} As-received $\SI{30}{\milli\metre}\times\SI{30}{\milli\metre}$ (111)B-oriented substrate A from vendor A; \subref{fig:subBb_photo} $\SI{30}{\milli\metre}\times\SI{30}{\milli\metre}$ (111)B-oriented substrate B from vendor B after preparation polish and etch; \subref{fig:subB2b_photo} $\SI{30}{\milli\metre}\times\SI{30}{\milli\metre}$ (111)B-oriented substrate B2 from vendor B after preparation polish and etch; \subref{fig:subCa_photo} as-received $\SI{15}{\milli\metre}\times\SI{15}{\milli\metre}$ (211)B-oriented substrate C from vendor A; and \subref{fig:subBb_photo_pieces} substrate B after it shattered during mounting for \ac{ftir}.}
