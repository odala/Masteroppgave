...
\begin{figure}[htbp]
    ...
    \centering
        \includegraphics[width=\linewidth]{subCa_afm_centre.png}
    ...
    \begin{subfigure}[t]{0.3\linewidth}
    \centering
        \includegraphics[width=\linewidth]{subCa_afm_leftedge.png}
    ...
    \begin{subfigure}[t]{0.3\linewidth}
    \centering
        \includegraphics[width=\linewidth]{subCa_afm_upperleftcorner.png}
...
\begin{figure}[htbp]
    ...
    \end{subfigure}%
    \hfill\hfill
    \begin{subfigure}[t]{0.04\linewidth}
    \centering
    ...
    \begin{subfigure}[t]{0.375\linewidth}
        \includegraphics[width=\linewidth]{subCa_afm_vs_sem.png}
