...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{subCa_25_ftir_spectra.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\linewidth]{subCa_25_ftir_transmission_at_k500cm-1.png}
