...
\Ac{ftir} transmission spectra were recorded from a $5\times5$ grid on the as-received substrate C. The grid points were placed \SI{2.3}{\milli\metre} from the edge and had \SI{2.6}{\milli\metre} between nearest neighbours. All but five measurements had an \ac{ir} transmittance between \SI{62}{\percent} and \SI{67}{\percent} in the wavenumber range between \SI{1000}{\centi\metre^{-1}} and \SI{5000}{\centi\metre^{-1}}, see Fig.~\ref{fig:subCa_ftir_spectra}. The indicator $T_{1000}/T_{5000}$ was a little bit less than one for these points. According to \citet{yujie2004infrared}, the \ac{czt} substrates with these characteristics are free of precipitates, have low free carrier concentration, and have resistivity that exceeds \SI{e6}{\ohm\centi\metre}.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\linewidth]{subCa_25_ftir_spectra.png}
...
\todo{Beskriv} Fig.~\ref{fig:subCa_ftir_map_500cm-1}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\linewidth]{subCa_25_ftir_transmission_at_k500cm-1.png}
    \caption[\Ac{ftir} transmission map for the as-received substrate C at $k=\SI{500}{\centi\metre^{-1}}$.]{\Acf{ftir} transmission map recorded from a $5\times5$ grid on the as-received (211)B-oriented substrate C at wavenumber $k=\SI{500}{\centi\metre^{-1}}$.}
    \label{fig:subCa_ftir_map_500cm-1}
\end{figure}
