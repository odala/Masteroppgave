...
A film of \acl{mct} was grown on substrate A by \ac{lpe}. Nomarski optical microscopy images reveal that the surface of the \ac{mct} film has wavy structures with a large number of circular features, as seen in Fig.~\ref{fig:subAc_om}. Two different kinds of circular features were observed: large circular defects with diameter of \SIrange{25}{40}{\micro\metre}, as seen in Fig.~\ref{fig:subAc_om_40um}, and donut-shaped defects with a diameter of \SIrange{10}{14}{\micro\metre}, as seen in Fig.~\ref{fig:subAc_om_10um}.
...
The donut-shaped defects had an elevated outer circle with a lowered centre, as seen in Fig.~\ref{fig:subAc_donutshaped}. \Ac{eds} spectra revealed that both the elevated and lowered part of the donut-shaped defect consisted of the same material as the surrounding substrate.

The large circular defects were  pits in the substrate surface with a crystalline shape in the middle, as seen in Fig.~\ref{fig:subAc_largecircular}. The \ac{eds} spectrum of the centre of the defect reveals that it consists of \ce{HgTe}, while the \ac{eds} spectrum of the side walls of the pit reveals that it consists of the same material as the surrounding substrate.

It was observed that a few of the donut-shaped defects had residual particles trapped in the middle, as seen in Fig.~\ref{fig:subAc_donut_w_particles}. The particles were found to be carbon based, see Fig.~\ref{fig:subAc_carbonbased}, and boron nitride (\ce{B2N3}), see Fig.~\ref{fig:subAc_NBholder}. Boron nitride is found in the \ac{lpe} equipment where it keeps the substrate fixed during growth. The boron nitride piece is polished once in a while to remove residue from the growth process. It may be the debris from the polishing which had settled on the grown film.
