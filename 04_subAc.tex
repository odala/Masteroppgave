...
%The circular shape of the large defects and the doughnut-shaped defects indicate that they are formed while the material were liquid during \ac{lpe}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{\textwidth}
        \caption{}\label{fig:subAc_carbonbased}
          ...
          \end{minipage}
    \end{subfigure}
    \caption[\Ac{sem} images, \ac{eds} spectra, and \ac{eds} atomic compositions of five different types of particles and defects found on \ac{mct} film grown on substrate A.]{High-resolution \ac{sem} images of five different types of particles and defects found on the \ac{mct} film grown on substrate A and the corresponding \ac{eds} spectra and atomic compositions: \subref{fig:subAc_doughnutshaped} doughnut-shaped defect; \subref{fig:subAc_largecircular} large circular defect; \subref{fig:subAc_carbonbased} carbon based particles; \subref{fig:subAc_NBholder} boron nitride (\ce{B2N3}) particle; and \subref{fig:subAc_mctparticle} \ac{mct} particle. The blue line represents the \ac{eds} spectrum of the particle, while the filled green represents the \ac{eds} spectrum of the underlying substrate.}\label{fig:subAc_sem_w_eds}
\end{figure}
%
\begin{figure}[htbp]
\ContinuedFloat
...
\begin{figure}[htbp]
    \centering
    \mySubfigure{0.49\textwidth}{LPE453_sem_02b_m009.png}[fig:subAc_doughnut_w_particles_C]
    \hfill
    \mySubfigure{0.49\textwidth}{LPE453_sem_02c_m005.png}[fig:subAc_doughnut_w_particles_BN]
    \caption[\Ac{sem} images of doughnut-shaped defects filled with carbon based particles and boron nitride particles.]{\Ac{sem} images of doughnut-shaped defects filled with \subref{fig:subAc_doughnut_w_particles_C} carbon based particles and \subref{fig:subAc_doughnut_w_particles_BN} boron nitride particles seen on \ac{mct} film grown by \ac{lpe} on (111)B-oriented substrate A.}
