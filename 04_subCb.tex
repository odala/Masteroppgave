...
\subsubsection{Carbon-based particles with \ce{Br}}
...
\Ac{eds} was used to get a quantitative analysis of the chemical composition of substrate C after a \ce{Br}:methanol etch. The results can be seen in Table~\ref{tab:subCb_eds_analysis}. The same elements were identified as before the etch: \ce{Te}, \ce{Cd}, \ce{Zn}, \ce{Al}, \ce{Si}, \ce{C}, and \ce{O}. The atomic concentration of \ce{Si} was the same as before the etch, which was surprising as the polishing grit density was reduced by a factor of 10. \todo{Mer Al, litt mer Si?}
